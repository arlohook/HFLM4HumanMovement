...
sim.results <- readRDS("./Simulation Study/Results/pffr Simulation Results 20.rds")
...
bs.basis = create.bspline.basis(rangeval = c(0,1), nbasis = 40, norder = 3)
## get betas
...
# Function to perform integration on the surface
...
saveRDS(result.list,file = "./Simulation Study/Results/pffr 20 Processed.rds")
